...
export const seedJobs: Job[] = [
  ...
  job({
    id: "job-drdo-research-fellow",
    title: "Junior Research Fellow (JRF)",
    companyId: "company-drdo",
    ...
    fresher: true,
    confidenceScore: 94,
    aiSummary: "Official defense research fellowship notice from DRDO. Verify specific laboratory rules, eligibility criteria, and interview dates.",
    priorityScore: 93
  }),
  job({
    id: "job-ssc-cgl-officer",
    title: "SSC Combined Graduate Level Notification",
    companyId: "company-ssc",
    ...
    fresher: true,
    confidenceScore: 92,
    aiSummary: "Official Staff Selection Commission (SSC) group B & C central government administrative recruitment portal. Review the PDF syllabus carefully.",
    priorityScore: 96
  }),
  job({
    id: "job-cognizant-programmer-analyst",
    ...
    fresher: true,
    confidenceScore: 93,
    aiSummary: "High-trust entry-level software development pathway at Cognizant. Confirm graduation eligibility and off-campus test guidelines on the official portal.",
    priorityScore: 89
  }),
  job({
    id: "job-tatasteel-get",
    title: "Graduate Engineer Trainee (GET)",
    companyId: "company-tatasteel",
    ...
    openedAt: daysAgo(4),
    jobType: "Private",
    categories: ["Private", "Freshers"],
    remote: false,
    fresher: true,
    confidenceScore: 95,
    aiSummary: "Excellent core engineering graduate role with robust corporate benefits. Apply strictly via Tata Steel's official website.",
    priorityScore: 94
  })
];
