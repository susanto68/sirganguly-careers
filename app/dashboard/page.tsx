        ...
        <div className="rounded-[1rem] bg-white/88 p-6 backdrop-blur-xl dark:bg-slate-950/70 sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-black leading-tight text-ink dark:text-white sm:text-5xl">
                {process.env.NODE_ENV !== "production"
                  ...
                  : "Find trusted jobs faster, with live AI guidance."}
              </h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300">
                {process.env.NODE_ENV !== "production"
                  ...
                  : "The dashboard matches verified opportunities, urgent deadlines, live AI career support, and official-source protection in one premium student command center."}
              </p>
            ...
            {process.env.NODE_ENV !== "production" ? (
              ...
              <div className="rounded-xl border border-slate-200/50 bg-slate-50/50 p-6 shadow-soft dark:border-slate-800 dark:bg-slate-900/50">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="text-xs font-black uppercase tracking-[0.18em] text-emerald-600 dark:text-emerald-400">AI Priority Guidance</p>
                    <h2 className="mt-1 text-2xl font-black">AI Career Assistant</h2>
                  </div>
                  <Sparkles className="h-7 w-7 text-emerald-600 dark:text-emerald-400 animate-pulse" />
                </div>
                <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                  Instantly optimize your resume, generate personalized learning roadmaps, and practice standard interviews customized to your exact skills.
                </p>
                <div className="mt-6">
                  <Link
                    href="/assistant"
                    className="btn-3d-slate inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg px-4 text-sm font-bold text-white"
                  >
                    Launch Career Brain &rarr;
                  </Link>
                </div>
              </div>
            )}
